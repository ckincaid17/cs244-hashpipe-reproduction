tshark -r equinix-chicago.dirA.20160121-125911.UTC.anon.pcap.gz -Y "tcp" -T fields -E separator=, -e ip.src -e ip.dst -e ip.proto -e tcp.srcport -e tcp.dstport > ../tutorials/examples/copy_to_cpu/header_fields.csv
